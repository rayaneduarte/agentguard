...
RESULTS_DIR = PROJECT_ROOT / "red-teaming" / "final-results"
RESULTS_DIR.mkdir(parents=True, exist_ok=True)


# Campanha de Red Teaming — Versão final v2
#
# Reteste formal após as correções aplicadas ao AgentGuard.
# Os ataques devem permanecer idênticos aos utilizados na baseline.
...
def invoke_turn(prompt, session_id):
    ...
    O modelo utilizado é o configurado no Harness implantado.
...
print("\n" + "=" * 70)
print("AGENTGUARD — RED TEAMING VERSÃO FINAL V2")
